...
import type { SystemMessage } from './transcript';
...
export type InjectionKind = 'base-prompt' | 'append-prompt' | 'context-file' | 'skills' | 'tool' | 'prompt-addition' | 'message';
...
export function buildSnapshot(items: readonly InjectionItem[], origin: CaptureOrigin, capturedAt: Date): InitialSnapshot {
...
function copyInjectedReferences(references: readonly InjectedReference[] | undefined): InjectedReference[] | undefined {
