...
import type { BuildSystemPromptOptions, ContextEvent, ToolInfo } from '@earendil-works/pi-coding-agent';
...
test('measureInjectedMessages attributes custom and context-only messages without session history', () => {
  ...
  const items = measureInjectedMessages([ordinaryUser, sessionCustom, contextCustom, injectedUser], [ordinaryUser, sessionCustom]);
