...
import { analyzeSystemPrompt, type PromptOptionsSlice, type ToolSlice } from '../../src/extensions/context-view/measure.ts';
...
test('analyzeSystemPrompt emits stable semantic ids and content-only measurements', () => {
  ...
  assert.deepEqual(
    ...
    ['base-prompt', 'tool:npm:web:search', 'tool:builtin', 'context-file:./AGENTS.md', 'skills', 'append-prompt', 'prompt-addition:aggregate'],
  );
