...
import { normalizeInlineText, normalizePreviewText } from '../../src/extensions/context-view/text.ts';
...
test('normalizePreviewText handles long unterminated terminal strings without quadratic rescanning', () => {
  ...
  const moduleUrl = new URL('../../src/extensions/context-view/text.ts', import.meta.url).href;
